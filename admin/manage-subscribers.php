...
{
$id=$_GET['del'];
$sql = "delete from  pato_subscribers  WHERE id=:id";
...
<head>
	...
	<title>Tutsy Delights | Manage Subscribers   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<button onClick="window.print()">Print Subscribers</button>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT * from pato_subscribers";
$query = $dbh -> prepare($sql);
$query->execute();
