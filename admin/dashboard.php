...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title> Tutsy Delights | Admin Dashboard</title>
									...
									<div class="row">
										<div class="col-md-3">
											<div class="panel panel-default">
												...
												<a href="reg-users.php" class="block-anchor panel-footer">Full Details <i
											...
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														...
														?>
														<div class="stat-panel-number h1 ">
															<?php echo htmlentities($orders); ?>
														</div>
														<div class="stat-panel-title text-uppercase">Listed cakes</div>
													</div>
												</div>
												<a href="manage-cake.php" class="block-anchor panel-footer text-center">Full
											...
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-number h1 ">
															<?php echo htmlentities($Orderings); ?>
														</div>
														<div class="stat-panel-title text-uppercase"> Orders</div>
													</div>
												</div>
												<a href="manage-Orderings.php"
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-primary text-light">
													<div class="stat-panel text-center">
														<?php
														$sql4 = "SELECT id from pato_subscribers ";
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														<?php
														$sql6 = "SELECT id from pato_contactusquery ";
