<?php
include("con.php");
include('admin/includes/leftbar.php');
...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Data pato_employees &raquo; Edit Data</h2>
			<hr />
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="department" class="form-control" required>
							<option value=""> - department Terbaru - </option>
                    ...
                    <div class="col-sm-3">
                    <b>department Sekarang :</b> <span class="label label-success"><?php echo $row['department']; ?></span>
				    </div>
				</div>
				<div class="form-group">
