		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="admin/risa/index.php">Master Data</a></li>
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								...
								<a href="index.php?aksi=delete&national_id='.$row['national_id'].'" title="Hapus Data" onclick="return confirm(\'Are yousure you want to delete user  '.$row['employee_name'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
