...
$eid=intval($_GET['eid']);
$status=1;
$sql = "UPDATE pato_contactusquery SET status=:status WHERE  id=:eid";
...
<head>
	...
	<title>Tutsy Delights | Manage Queries   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<button onClick="window.print()">Print Contact Queries</button>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT * from  pato_contactusquery ";
$query = $dbh -> prepare($sql);
$query->execute();
