...
$sql="INSERT INTO  subcategory(categoryid,subcategory) VALUES(:category,:subcat)";
...
<head>
	...
	<title>Tutsy Delights | Sub Category Brand</title>
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="subcategory" id="brand" required>
												</div>
											</div>
				<div class="form-group">
