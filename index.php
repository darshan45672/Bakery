      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <a href="" class="btn">Order Now <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<span class="price"> Offer  <?php echo htmlentities($row['productPrice']);?> <s> Price <?php echo htmlentities($row['productPriceBeforeDiscount']);?></s></span>
...
<?php
  ...
  ?>
<iframe name="Framename" src="rating/index.php" width="100" height="30" frameborder="0" scrolling="no" style="width:100%;"> </iframe>
